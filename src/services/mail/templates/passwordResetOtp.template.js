export const passwordResetOtpTemplate = ({ firstName, code, ttlMinutes }) => {
  ...
  const subject = `Your Immify password reset code: ${code}`;

  const text = [
    `Hi ${safeName},`,
    '',
    `We received a request to reset your Immify password.`,
  ...
  <div style="font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#0f172a;">
    ...
    <p style="margin:0 0 16px;font-size:14px;line-height:1.5;">Hi ${safeName}, use the code below to set a new password for your Immify account.</p>
